...
export const productsData = [
  ...
  },
  {
    ...
    plans: [
      {
        name: "Básico",
        description: "Plan individual, ideal para llevar cuentas personales.",
        price: "Gratuito",
        features: [
          "Plan individual, ideal para llevar cuentas personales",
          "No puede crear ningún grupo",
          "Control de gastos",
          "Presupuestos mensuales",
          "No tiene estadísticas detalladas",
      ...
      },
      {
        ...
        features: [
          ...
          "Cada grupo de hasta 8 miembros",
          "Control de gastos",
          "Presupuestos mensuales",
